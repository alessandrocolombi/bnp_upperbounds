...
seed = 121321
M = 100
ExpGeneric_species_run = function(M, n, name, params,
                                       alpha = 0.05,Rmax = 100, 
                                       M_max = 200, M_DM = NULL, seed = 121321)
{
  source("../../R/Rfunctions.R")
  Rcpp::sourceCpp("../../src/RcppFunctions.cpp")
  # From BinomialCIs
...
ExpGeneric_species = function(name,M,n,params,Nrep = 100, 
                                   alpha = 0.05,Rmax = 100, 
                                   ...
                                   parallel = TRUE, num_cores = 5)
{
  ...
  # Sequential case
  if(!parallel){
    res_list = lapply(seeds, function(seed) ExpGeneric_species_run(
